                    ...
                    <div class="col-12">
                        <div class="featured-cat-active owl-carousel owl-arrow-style">
                            <div class="pro-layout-two-single-item">
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Audio & Home
                                                Theater</a></h4>
                                    ...
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img1.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Cellphones &
                                                Accessories</a></h4>
                                    ...
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img2.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div> <!-- </ end single item -->
                            <div class="pro-layout-two-single-item">
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Camera, Photo &
                                                Video</a></h4>
                                    ...
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img3.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="product-layout-two mb-30">
                                    ...
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img4.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div> <!-- </ end single item -->
                            <div class="pro-layout-two-single-item">
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Smart Watch &
                                                Accessories</a></h4>
                                    ...
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img5.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Laptop &
                                                Computere</a></h4>
                                    ...
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img6.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div> <!-- </ end single item -->
                            <div class="pro-layout-two-single-item">
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Headphones &
                                                Accessories</a></h4>
                                    ...
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img7.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Network
                                                Devices</a></h4>
                                        <p class="total-items"> 5 products </p>
                                        <a href="shop-grid-left-sidebar.html" class="shop-btn">+ shop now</a>
                                    </div>
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img8.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div> <!-- </ end single item -->
                            <div class="pro-layout-two-single-item">
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Video Games
                                                Cosoles</a></h4>
                                        <p class="total-items"> 0 products </p>
                                        <a href="shop-grid-left-sidebar.html" class="shop-btn">+ shop now</a>
                                    </div>
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img9.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="product-layout-two mb-30">
                                    <div class="product-layout-info">
                                        <h4 class="pro-name"><a href="shop-grid-left-sidebar.html">Quadcopters &
                                                Accessories</a></h4>
                                    ...
                                    <div class="product-layout-thumb">
                                        <a href="shop-grid-left-sidebar.html"><img
                                                src="{{ url('home') }}/assets/img/product/pro-layout-img10.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div> <!-- </ end single item -->

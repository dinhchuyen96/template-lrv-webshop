...
class Product extends Model
{
    ...
    protected $fillable = ['id', 'name', 'amout', 'number_sale', 'sort_description', 'description', 'status', 'price', 'percent_sale', 'sale_price', 'image', 'parent_cat', 'category_id', 'avg_rating'];
